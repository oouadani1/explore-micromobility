window.MICROMOBILITY_TRANSLATIONS = {
  ui: {
    es: {
      ...
      seeAllDeviceTypes: "Otras posibles opciones de micromovilidad",
      howResultsAreShown: "Cómo Explore Micromobility muestra opciones",
      ...
      resultsMethodologyIntro: "Esta sección explica cómo la herramienta suma puntos, muestra tus respuestas y señala por qué algunas opciones pueden aparecer más abajo o no aparecer.",
      whatAffectsScoring: "Tus respuestas",
      whatHelpedShowResults: "Qué sumó puntos para estas opciones",
      whatMayLowerOptions: "Por qué algunas opciones pueden aparecer más abajo o no aparecer",
      methodologyReferences: "Reglas y referencias usadas en esta herramienta",
      noAdditionalVisibilityRules: "No hubo notas adicionales que afectaran qué opciones aparecieron para estas respuestas.",
      ...
      visibilityRulePolicy: "Algunas opciones se muestran con más cautela en esta herramienta para seguir las reglas de seguridad usadas aquí, aunque la ley estatal vigente no use exactamente las mismas categorías.",
      readCommissionReport: "Leer el informe de la Special Commission",
      massLawAboutBicycles: "Ley de Massachusetts sobre bicicletas",
      ...
      whyConsiderIt: "Por qué esta opción puede ser adecuada",
      whyThisFitsForYou: "Por qué esta opción puede ser adecuada",
      whyThisFits: "Por qué esta opción puede ser adecuada",
      thingsToConsider: "Qué saber sobre esta opción",
      typicalCost: "Costo típico",
      nextSteps: "Más recursos sobre esta opción",
      ...
      reviewResults: "Explorar resultados",
