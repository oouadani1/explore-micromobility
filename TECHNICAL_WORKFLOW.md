...
4. Question 1 acts as four distinct pathways or branches, with each pathway using slightly different language and override rules.
5. The app shows one question at a time, with a maximum of 9 total questions, and the user selects an answer and then uses the Next button to navigate.
...
- The app currently allows `140,041` unique completed answer combinations.
- This count reflects the live branching logic as of May 12, 2026, including:
  ...
  - the `child` pathway not including `carryChildren`
